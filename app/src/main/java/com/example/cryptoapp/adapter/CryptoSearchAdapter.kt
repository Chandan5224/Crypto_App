...
class CryptoSearchAdapter : RecyclerView.Adapter<CryptoSearchAdapter.CryptoSearchViewHolder>() {

    inner class CryptoSearchViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val cryptoImage: ImageView = itemView.findViewById(R.id.imageViewCrypto)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CryptoSearchViewHolder {
        return CryptoSearchViewHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.currency_search_item, parent, false)
        )
    }
